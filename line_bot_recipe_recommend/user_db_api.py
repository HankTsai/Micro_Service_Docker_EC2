...
class DataBaseConnector(object):
    # 初始化設定
    def __init__(self):
        self.redis = redis.StrictRedis(host="redis", port=6379, decode_responses=True)
    ...
    def connect_to_mysql(db_name):
        ...
        db = db_name
        charset = 'utf8mb4'
        conn = pymysql.connect(host="mysql", port=port, user=user, passwd=passwd, db=db, charset=charset)
